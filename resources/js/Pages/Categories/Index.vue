                                ...
                                <tr v-for="(category) in categories.data"
                                    ...
                                    <td class="border-slate-200">
                                        <div class="grid grid-cols-3 gap-0">
                                            <div class="">
                                                <Link :href="route('categories.edit', category.id)" class="text-gray-300 hover:text-gray-700">
                                            ...
                                            <div class="">
                                                <Link :href="route('categories.show', category.id)" class="text-blue-300 hover:text-blue-700">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
export default {
    ...
    methods: {
        ...
        toastDeleteFail() {
            return {
                type: 'danger',
                message: 'Failed. Category is being used in products.'
            }
        },
            ...
            axios.delete("/categories/" + category)
                .catch(function (error) {
                    if (error.response) {
                        ...
                        this.$page.props.toast = this.toastDeleteFail();
                        this.$inertia.reload();
                    }
                }).then(response => {
                    this.$page.props.toast = this.toastDeleteSuccess();
